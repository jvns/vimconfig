" Base16 Julia (https://github.com/chriskempson/base16)
" Scheme: Julia Evans (https://jvns.ca)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-julia.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-julia"
