#!/bin/sh
# Base16 Julia - Shell color setup script
...
color01="F9/6A/38" # Base 08 - Red
color02="F9/6A/38" # Base 0B - Green
...
color_foreground="22/22/22" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="22/22/22" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pj ffffff # selection color
  printf $printf_template_custom Pk 222222 # selected text color
  printf $printf_template_custom Pl 222222 # cursor
